    ...
    return (
        ...
        >
            <motion.div
                ...
                className="w-14 h-14 bg-[#25D366] rounded-full shadow-lg shadow-green-500/30 flex items-center justify-center text-white border-2 border-white/20 hover:shadow-green-500/50 hover:border-white/40 transition-all"
            >
